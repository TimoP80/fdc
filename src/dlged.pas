...
type
    TForm2 = class(TForm)
        ...
        Button7: TButton;
        Button8: TButton;
    startcondsbtn: TButton;
    variablesbtn: TButton;
        Button15: TButton;
        Button16: TButton;
        Button9: TButton;
        Button10: TButton;
        ...
        procedure startcondsbtnClick(Sender: TObject);
...
procedure TForm2.variablesbtnClick(Sender: TObject);
begin
    updatevars;
    form21.showmodal;
...
procedure TForm2.startcondsbtnClick(Sender: TObject);
begin
