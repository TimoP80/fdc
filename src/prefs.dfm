object Form10: TForm10
  ...
  object JvPageControl1: TJvPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object globalfontsize: TEdit
        Left = 104
        Top = 82
        Width = 52
        Height = 21
        TabOrder = 11
        OnKeyUp = globalfontsizeKeyUp
      end
      object JvFontComboBox1: TJvFontComboBox
        ...
        Width = 186
        Height = 22
        DroppedDownWidth = 186
        MaxMRUCount = 0
        FontName = 'Tahoma'
        ItemIndex = 231
        Sorted = False
        TabOrder = 12
        OnClick = JvFontComboBox1Click
      end
    end
    ...
    object TabSheet5: TTabSheet
      ...
      object Label14: TLabel
        ...
        Height = 13
        Caption = 
          'This section allows you to select a VCL style from the available' +
          ' styles in the EXE'
      end
  ...
  object StyleChangeTimer: TTimer
    Enabled = False
    OnTimer = StyleChangeTimerTimer
    Left = 216
    Top = 248
  end
end
