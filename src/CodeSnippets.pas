...
uses  VCL.dialogs, SysUtils, Classes, CocoBase;
...
function TCodeSnippetsScanner.Equal(s: ansistring): Boolean;
var
  i: Integer;
  q: Longint;
begin
...
function TCodeSnippets.ErrorStr(const ErrorCode: Integer; const Data: ansiString): ansiString;
begin
  case ErrorCode of
