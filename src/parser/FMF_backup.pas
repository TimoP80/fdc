...
uses Classes, CocoBaseNew, Dialogs, mwStringHashList, SharedDLGData, SysUtils;
const
  maxT      = 83;
  maxP      = 84;
type
...
const
  ...
  _stringSym        = 4; HexLiteralSym = 5; _equal_equalSym = 6; _bang_equalSym = 7;
  _lessSym          = 8; _greaterSym = 9; _greater_equalSym = 10; _less_equalSym = 11;
  LINK_underscoreNEXTSym = 12; NONESym = 13; ANDSym = 14; ORSym = 15;
  INTSym            = 16; _equalSym = 17; LINKFLAGSSym = 18;
  SKILL_underscoreCHECKSym = 19; CUSTOM_underscorePROCSym = 20;
  REACTIONSym       = 21; REACTION_underscoreBADSym = 22;
  REACTION_underscoreNEUTRALSym = 23; REACTION_underscoreGOODSym = 24;
  GENDERSym         = 25; FEMALESym = 26; MALESym = 27; PLAYERTEXTSym = 28;
  LINKTOSym         = 29; CONDITIONSSym = 30; _lbraceSym = 31; _commaSym = 32;
  _rbraceSym        = 33; NOTESSym = 34; FLOATNODESym = 35; SSLSym = 36;
  VAR_underscorePARAMSym = 37; EVALSym = 38;
  VALUE_underscoreTO_underscoreCHECKSym = 39; INI_underscoreINDEXSym = 40;
  LINKSym           = 41; CONDSym = 42; TARGET_underscoreNODESym = 43;
  START_underscoreCONDITIONSSym = 44; DEFAULT_underscoreCONDITIONSym = 45;
  _semicolonSym     = 46; ASSOCIATE_underscoreNODESym = 47;
  EXEC_underscoreSCRIPT_underscoreCODESym = 48; IMPORTSym = 49; LOCALSym = 50;
  EXPORTSym         = 51; VARSym = 52; VARSSym = 53;
  DEFINE_underscoreSKILL_underscoreCHECKS = 54; SKILL_underscoreNUMSym = 55;
  DIFFICULTY_underscoreMODIFIERSym = 56; ONSUCCESSSym = 57;
  _equal_greaterSym = 58; ONFAILURESym = 59; NODESym = 60;
  IS_underscoreWTGSym = 61; TRUESym = 62; FALSESym = 63;
  INSERT_underscoreCUSTOM_underscoreCODES = 64; NPCTEXTSym = 65;
  NPCFEMALETEXTSym  = 66; OPTIONSSym = 67; TIMEEVENTSym = 68;
  FIXED_underscorePARAM_underscoreNAMESym = 69; ENUMSym = 70;
  ISRANDOMINTERVALSym = 71; INTERVALMINSym = 72; INTERVALMAXSym = 73;
  INTERVALSym       = 74; CODESym = 75; DEFAULT_underscoreEVENTSym = 76;
  NPCNAMESym        = 77; LOCATIONSym = 78; DESCRIPTIONSym = 79;
  UNKNOWN_underscoreDESCSym = 80; KNOWN_underscoreDESCSym = 81;
  DETAILED_underscoreDESCSym = 82; NOSYMB = 83; PreProcessorSym = 84; _noSym = NOSYMB;   {error token code}
...
begin
  ...
  fStartState[32]  := 29; fStartState[33] := 17; fStartState[34] := 7; fStartState[35] := 10;
  fStartState[36]  := 9; fStartState[37] := 29; fStartState[38] := 29; fStartState[39] := 29;
  fStartState[40]  := 29; fStartState[41] := 29; fStartState[42] := 29; fStartState[43] := 2;
  fStartState[44]  := 24; fStartState[45] := 12; fStartState[46] := 4; fStartState[47] := 29;
  ...
  fStartState[56]  := 11; fStartState[57] := 11; fStartState[58] := 29; fStartState[59] := 26;
  fStartState[60]  := 19; fStartState[61] := 15; fStartState[62] := 20; fStartState[63] := 29;
  ...
  fStartState[120] := 29; fStartState[121] := 29; fStartState[122] := 29; fStartState[123] := 23;
  fStartState[124] := 29; fStartState[125] := 25; fStartState[126] := 29; fStartState[127] := 29;
  ...
  fStartState[196] := 1; fStartState[197] := 1; fStartState[198] := 29; fStartState[199] := 29;
  ...
  fStartState[212] := 29; fStartState[213] := 29; fStartState[214] := 1; fStartState[215] := 29;
  ...
  fStartState[228] := 1; fStartState[229] := 1; fStartState[230] := 29; fStartState[231] := 29;
  ...
  fStartState[244] := 29; fStartState[245] := 29; fStartState[246] := 1; fStartState[247] := 29;
...
begin
  case ErrorCode of
    ...
    10 : Result := '">=" expected';
    11 : Result := '"<=" expected';
    12 : Result := '"LINK_NEXT" expected';
    13 : Result := '"NONE" expected';
    14 : Result := '"AND" expected';
    15 : Result := '"OR" expected';
    16 : Result := '"INT" expected';
    17 : Result := '"=" expected';
    18 : Result := '"LINKFLAGS" expected';
    19 : Result := '"SKILL_CHECK" expected';
    20 : Result := '"CUSTOM_PROC" expected';
    21 : Result := '"REACTION" expected';
    22 : Result := '"REACTION_BAD" expected';
    23 : Result := '"REACTION_NEUTRAL" expected';
    24 : Result := '"REACTION_GOOD" expected';
    25 : Result := '"GENDER" expected';
    26 : Result := '"FEMALE" expected';
    27 : Result := '"MALE" expected';
    28 : Result := '"PLAYERTEXT" expected';
    29 : Result := '"LINKTO" expected';
    30 : Result := '"CONDITIONS" expected';
    31 : Result := '"{" expected';
    32 : Result := '"," expected';
    33 : Result := '"}" expected';
    34 : Result := '"NOTES" expected';
    35 : Result := '"FLOATNODE" expected';
    36 : Result := '"SSL" expected';
    37 : Result := '"VAR_PARAM" expected';
    38 : Result := '"EVAL" expected';
    39 : Result := '"VALUE_TO_CHECK" expected';
    40 : Result := '"INI_INDEX" expected';
    41 : Result := '"LINK" expected';
    42 : Result := '"COND" expected';
    43 : Result := '"TARGET_NODE" expected';
    44 : Result := '"START_CONDITIONS" expected';
    45 : Result := '"DEFAULT_CONDITION" expected';
    46 : Result := '";" expected';
    47 : Result := '"ASSOCIATE_NODE" expected';
    48 : Result := '"EXEC_SCRIPT_CODE" expected';
    49 : Result := '"IMPORT" expected';
    50 : Result := '"LOCAL" expected';
    51 : Result := '"EXPORT" expected';
    52 : Result := '"VAR" expected';
    53 : Result := '"VARS" expected';
    54 : Result := '"DEFINE_SKILL_CHECK" expected';
    55 : Result := '"SKILL_NUM" expected';
    56 : Result := '"DIFFICULTY_MODIFIER" expected';
    57 : Result := '"ONSUCCESS" expected';
    58 : Result := '"=>" expected';
    59 : Result := '"ONFAILURE" expected';
    60 : Result := '"NODE" expected';
    61 : Result := '"IS_WTG" expected';
    62 : Result := '"TRUE" expected';
    63 : Result := '"FALSE" expected';
    64 : Result := '"INSERT_CUSTOM_CODE" expected';
    65 : Result := '"NPCTEXT" expected';
    66 : Result := '"NPCFEMALETEXT" expected';
    67 : Result := '"OPTIONS" expected';
    68 : Result := '"TIMEEVENT" expected';
    69 : Result := '"FIXED_PARAM_NAME" expected';
    70 : Result := '"ENUM" expected';
    71 : Result := '"ISRANDOMINTERVAL" expected';
    72 : Result := '"INTERVALMIN" expected';
    73 : Result := '"INTERVALMAX" expected';
    74 : Result := '"INTERVAL" expected';
    75 : Result := '"CODE" expected';
    76 : Result := '"DEFAULT_EVENT" expected';
    77 : Result := '"NPCNAME" expected';
    78 : Result := '"LOCATION" expected';
    79 : Result := '"DESCRIPTION" expected';
    80 : Result := '"UNKNOWN_DESC" expected';
    81 : Result := '"KNOWN_DESC" expected';
    82 : Result := '"DETAILED_DESC" expected';
    83 : Result := 'not expected';
    84 : Result := 'invalid TimedEventData';
    85 : Result := 'invalid Node';
    86 : Result := 'invalid _variable';
    87 : Result := 'invalid Options';
    88 : Result := 'invalid Options';
    89 : Result := 'invalid Options';
    90 : Result := 'invalid Condition';
    91 : Result := 'invalid Condition';
    92 : Result := 'invalid Main';
...
procedure TFMF._TimedEvents;begin
  currentdlg.timedeventcnt    := 0;;
  ...
  _TimedEventData;
  while (fCurrentInputSymbol = TIMEEVENTSym) do begin
    _TimedEventData;
  end;
end;

procedure TFMF._TimedEventData;begin
  Expect(TIMEEVENTSym);
...
procedure TFMF._Nodes;begin
  _Node;
  while (fCurrentInputSymbol = NODESym) do begin
    _Node;
  end;
end;

procedure TFMF._Node;begin
  Expect(NODESym);
  Expect(_stringSym);
  ...
  if (fCurrentInputSymbol = IS_underscoreWTGSym) then begin
    Get;
    Expect(_equalSym);
    if (fCurrentInputSymbol = TRUESym) then begin
      Get;
  ...
  if (fCurrentInputSymbol = DEFINE_underscoreSKILL_underscoreCHECKS) then begin
    _SkillCheck;
    while (fCurrentInputSymbol = DEFINE_underscoreSKILL_underscoreCHECKS) do begin
      _SkillCheck;
    end;
  end;
  if (fCurrentInputSymbol = INSERT_underscoreCUSTOM_underscoreCODES) then begin
    Get;
    Expect(_lbraceSym);
    Expect(_stringSym);
    currentdlg.nodes[currentdlg.nodecount].customcode :=
  ...
  if (fCurrentInputSymbol = NPCFEMALETEXTSym) then begin
    Get;
    Expect(_stringSym);
...
procedure TFMF._SkillCheck;begin
...
procedure TFMF.__variable;begin
  new(currentdlg.variables[currentdlg.varcnt]); currentdlg.variables[currentdlg.varcnt].flags := VAR_FLAGS_NONE;;
  if (fCurrentInputSymbol = IMPORTSym) or (fCurrentInputSymbol = LOCALSym) or (fCurrentInputSymbol = EXPORTSym) then
  begin
    if (fCurrentInputSymbol = IMPORTSym) then begin
      Get;
      currentdlg.variables[currentdlg.varcnt].flags := VAR_FLAGS_IMPORT;;
    end else if (fCurrentInputSymbol = LOCALSym) then begin
      Get;
  ...
  Expect(VARSym);
  Expect(identifierSym);
  currentdlg.variables[currentdlg.varcnt].vartype := -1; currentdlg.variables[currentdlg.varcnt].Name := lexstring;;
  if (fCurrentInputSymbol = NOTESSym) then begin
    Get;
    Expect(_stringSym);
  ...
  if (fCurrentInputSymbol = _equalSym) then begin
    ...
    end else if (fCurrentInputSymbol = _floatSym) then begin
      Get;
...
procedure TFMF._FloatNodes;begin
  _FloatNode;
  while (fCurrentInputSymbol = FLOATNODESym) do begin
    _FloatNode;
  end;
end;

procedure TFMF._CustomScript;begin
...
procedure TFMF._CustomProc;begin
...
procedure TFMF._StartConditions;begin
  currentdlg.startconditioncnt := 0;;
...
procedure TFMF._StartCond;begin
...
procedure TFMF._ScriptLine;begin
  Expect(_stringSym);
  {$IFNDEF FMFCBuild}
...
procedure TFMF._FloatNode;begin
  Expect(FLOATNODESym);
  Expect(_stringSym);
...
procedure TFMF._Options;begin
  ...
  currentdlg.nodes[currentdlg.nodecount].options[currentdlg.nodes[currentdlg.nodecount].optioncnt].conditioncnt :=
    0; currentdlg.nodes[currentdlg.nodecount].options[currentdlg.nodes[currentdlg.nodecount].optioncnt].intcheck
  := 4;;
  ...
  if (fCurrentInputSymbol = LINKFLAGSSym) then begin
    Get;
    if (fCurrentInputSymbol = SKILL_underscoreCHECKSym) then begin
      Get;
      currentdlg.nodes[currentdlg.nodecount].options[currentdlg.nodes[currentdlg.nodecount].optioncnt].
        link_to_skillcheck :=
        True; currentdlg.nodes[currentdlg.nodecount].options[currentdlg.nodes[
        currentdlg.nodecount].optioncnt].link_to_proc := False;;
    end else if (fCurrentInputSymbol = CUSTOM_underscorePROCSym) then begin
      Get;
      currentdlg.nodes[currentdlg.nodecount].options[currentdlg.nodes[currentdlg.nodecount].optioncnt].
        link_to_skillcheck :=
        False; currentdlg.nodes[currentdlg.nodecount].options[currentdlg.nodes[
        currentdlg.nodecount].optioncnt].link_to_proc := True;;
    end else
    begin SynError(87);
    end;
  end;
  if (fCurrentInputSymbol = REACTIONSym) then begin
    Get;
    Expect(_equalSym);
    if (fCurrentInputSymbol = REACTION_underscoreBADSym) then begin
      Get;
      currentdlg.nodes[currentdlg.nodecount].options[currentdlg.nodes[currentdlg.nodecount].optioncnt].reaction :=
        REACTION_BAD;
    end else if (fCurrentInputSymbol = REACTION_underscoreNEUTRALSym) then begin
      Get;
      currentdlg.nodes[currentdlg.nodecount].options[currentdlg.nodes[currentdlg.nodecount].optioncnt].reaction :=
        REACTION_NEUTRAL;
    end else if (fCurrentInputSymbol = REACTION_underscoreGOODSym) then begin
      Get;
      currentdlg.nodes[currentdlg.nodecount].options[currentdlg.nodes[currentdlg.nodecount].optioncnt].reaction :=
        REACTION_GOOD;
    end else
  ...
  if (fCurrentInputSymbol = GENDERSym) then begin
    Get;
    Expect(_equalSym);
    if (fCurrentInputSymbol = FEMALESym) then begin
      Get;
      currentdlg.nodes[currentdlg.nodecount].options[currentdlg.nodes[currentdlg.nodecount].optioncnt].genderflags :=
        GENDER_FEMALE;
    end else if (fCurrentInputSymbol = MALESym) then begin
      Get;
      currentdlg.nodes[currentdlg.nodecount].options[currentdlg.nodes[currentdlg.nodecount].optioncnt].genderflags :=
        GENDER_MALE;;
    end else
  ...
  currentdlg.nodes[currentdlg.nodecount].options[currentdlg.nodes[currentdlg.nodecount].optioncnt].nodelink   :=
    parse_string(lexstring);;
  if (fCurrentInputSymbol = CONDITIONSSym) then begin
    Get;
    Expect(_lbraceSym);
    _Condition;
    while (fCurrentInputSymbol = _commaSym) do begin
  ...
  currentdlg.nodes[currentdlg.nodecount].options[currentdlg.nodes[currentdlg.nodecount].optioncnt].notes :=
    parse_string(lexstring); Inc(currentdlg.nodes[currentdlg.nodecount].optioncnt);;
end;

procedure TFMF._Condition;begin
  Expect(identifierSym);
  tempcondcheck := lexstring;;
  Expect(identifierSym);
  tempcondfield := lexstring;;
  if (fCurrentInputSymbol < 16) { prevent range error } and (fCurrentInputSymbol in
    [_equal_equalSym, _bang_equalSym, _lessSym, _greaterSym, _greater_equalSym, _less_equalSym]) then begin
    case fCurrentInputSymbol of
  ...
  if (fCurrentInputSymbol = LINK_underscoreNEXTSym) then begin
    Get;
    if (fCurrentInputSymbol = NONESym) then begin
      Get;
      tempcondlink := LINKAGE_NONE;;
    end else if (fCurrentInputSymbol = ANDSym) then begin
      Get;
      tempcondlink := LINKAGE_AND;;
    end else if (fCurrentInputSymbol = ORSym) then begin
      Get;
...
procedure TFMF._Main;begin
  case fCurrentInputSymbol of
    NPCNAMESym : begin
      _Globals;
    end;
    DEFAULT_underscoreEVENTSym : begin
      _TimedEvents;
    end;
    EXEC_underscoreSCRIPT_underscoreCODESym : begin
      _CustomScript;
    end;
    START_underscoreCONDITIONSSym : begin
      _StartConditions;
    end;
    FLOATNODESym : begin
      _FloatNodes;
    ...
    CUSTOM_underscorePROCSym : begin
      _CustomProc;
    end;
    else
    begin SynError(92);
...
procedure TFMF._VarDefs;begin
  Expect(VARSSym);
  currentdlg.varcnt := 0;;
  Expect(_lbraceSym);
  if (fCurrentInputSymbol = IMPORTSym) or (fCurrentInputSymbol = LOCALSym) or
    (fCurrentInputSymbol = EXPORTSym) or (fCurrentInputSymbol = VARSym) then begin
    __variable;
    while (fCurrentInputSymbol = IMPORTSym) or (fCurrentInputSymbol = LOCALSym) or
      (fCurrentInputSymbol = EXPORTSym) or (fCurrentInputSymbol = VARSym) do begin
      __variable;
    end;
  end;
  Expect(_rbraceSym);
...
procedure TFMF._FMF;begin
  Init;;
  if (fCurrentInputSymbol = VARSSym) then begin
    _VarDefs;
  end;
  _Main;
