...
begin
  ...
  writeln('Script template is: ',script_template);
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          ;
          if (cur_node.options[j].conditions[c].check_type=CHECK_TYPE_CUSTOM_CODE) then

          conds := conds + '("' + cur_node.options[j].conditions[c].resolved_code + '")' else
