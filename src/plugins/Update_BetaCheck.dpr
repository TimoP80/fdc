...
begin;
result := 'Check for new beta releases';
end;
...
begin;
result := 'This plugin checks for new beta releases';
end;
...
cfg := TInifile.create(basepath+'\plugins\betainfo.ini');
datamodule1.mxWebUpdate1.ProductInfo.Version := cfg.ReadString('Beta Version Information','CurrentVersion','1.00');
...
exports
   GetPluginName,  GetInterfaceVersion,
