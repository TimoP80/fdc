...
type
  dialoguenode = record
    ...
    custom_code: string;
    playerdata: array [0..20] of poption;
...
function TDLGDef.ErrorStr(const ErrorCode: integer; const Data: string): string;
begin
  case ErrorCode of
    0:
      Result := 'EOF expected';
...
function TDLGDef.GetVersion: string;
var
...
function TDLGDef.GetVersionComment: string;
begin
  Result := 'SSL Dialogue Generator';
end;

function TDLGDef.GetGrammarAuthor: string;
begin
  Result := 'T. Pitkänen';
end;

function TDLGDef.GetGrammarCopyright: string;
begin
  Result := '(c) 2003 Dj Unique';
end;

procedure TDLGDef.SetVersion(const Value: string);
begin
