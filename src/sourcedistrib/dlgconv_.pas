...
Copyright (C) 2005-2009 T. Pitkänen
---------------------------------------------------------------
...
uses
  ...
  Messages,
  Inifiles,
  CocoBaseNew, ScriptCompilerIntf,
  fmxutils,
  shareddlgdata,
  SysUtils,
  Registry,
...
begin
  ...
  begin
    ...
    //writeln('data := ',data);
    config := TInifile.Create(Data + '\fmfdlg.ini');
...
begin
  MessageBox(0, 'Dialogue Converter' + #13 + #10 +
    'version 1.03' + #13 + #10 + '' + #13 + #10 + '(c) 2006-2015 T. Pitkänen',
