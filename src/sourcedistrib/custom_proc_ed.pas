...
uses
  Classes, CodeSnippets, Controls, debugwnd, Dialogs, ExtCtrls, Forms,
  Graphics, Messages, poptadd, SharedDLGData, StdCtrls, SynEdit, SynMemo, SysUtils, TE_DataEd, Variants, Windows;
type
  TForm23 = class(TForm)
    Bevel1:    TBevel;
    SynMemo1:  TSynMemo;
