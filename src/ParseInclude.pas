...
procedure TParseInclude.WriteStr(S: ansistring);
begin
  S := S + #13#10;
...
function TParseIncludeScanner.GetNextSymbolString: ansistring;
var
  i: integer;
  q: integer;
begin
...
function TParseInclude.ErrorStr(const ErrorCode: integer; const Data: ansistring): ansistring;
begin
  case ErrorCode of
...
function TParseInclude.GetVersion: ansistring;
var
...
function TParseInclude.GetVersionComment: ansistring;
begin
  Result := 'SSL Include files parser';
end;

function TParseInclude.GetGrammarAuthor: ansistring;
begin
  Result := 'T. Pitkänen';
end;

function TParseInclude.GetGrammarCopyright: ansistring;
begin
  Result := '(c) 2003 Dj Unique';
end;

procedure TParseInclude.SetVersion(const Value: ansistring);
begin
